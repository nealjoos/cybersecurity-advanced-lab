...
set-addefaultdomainpasswordpolicy insecure.cyb -complexityenabled $false -maxpasswordage 0 -minpasswordage 0 -MinPasswordLength 0
...
write-host "dns 10 dinges in registry"

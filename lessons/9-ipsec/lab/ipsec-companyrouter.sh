...
# Manual IPSec for companyrouter
...
# DIRECTION: TRAFFIC COMING FROM HOMEROUTER TO COMPANYROUTER AND INTERNAL NETWORKS
...
## Activate the tunnel for traffic coming from homerouter to companyrouter
...
# DIRECTION: TRAFFIC COMING FROM INTERNAL NETWORKS TO HOMEROUTER
